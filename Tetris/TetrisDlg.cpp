...
{
	m_shapeI.Create(_T("STATIC"), _T(""), WS_CHILD | WS_VISIBLE, CRect(100, 100, 120, 120), this, 1234);

	m_shapeL.Create(_T("STATIC"), _T(""), WS_CHILD | WS_VISIBLE, CRect(100, 100, 120, 120), this, 1235);
...
BOOL CTetrisDlg::OnInitDialog()
{
	...
	// TODO: 在此添加额外的初始化代码
//	m_dmdLine.Create( _T("STATIC"), _T(""), WS_CHILD | WS_VISIBLE, CRect(100, 100, 120, 120), this, 1234);
